...
public class ListBankAdapter extends ArrayAdapter<Bank> {
    ...
    public ListBankAdapter(Context context, int resourceId, List<Bank> banks) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.name.setText(bank.getEnName());

        holder.adresse.setText(bank.getEnadresse());
    //    holder.dist.setText(String.valueOf(place.getLat()));


      LatLng pos = ((Application) context.getApplicationContext()).getPosition();
        double distance = getDistance(pos.latitude, pos.longitude, bank.getLat(), bank.getLon());
